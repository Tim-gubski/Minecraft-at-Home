...
class GameScene extends Scene {
    ...
    generateChunk(chunkx, chunkz) {
		// create the grass blocks, make them instances for faster rendering
		...
		// generate tiles per chunk, grabbing from the instance matrix and
		// moving the tiles to their locations in the chunk generated by perlin
		// noise
